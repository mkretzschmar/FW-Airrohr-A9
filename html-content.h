...
<br/><small style='color:#000;font-weight:700'>ID: {id} ({macid})<br/>" INTL_FIRMWARE ": " SOFTWARE_VERSION_STR "/" INTL_LANG "&nbsp;(" __DATE__ ")<br/>\
...
const char WEB_PAGE_FOOTER[] PROGMEM = "<br/><br/>"
		...
		"<a href='https://www.samsol.de/' target='_blank' rel='noreferrer' style='color:#3ba;'>"
		"SAMSOL</a>&nbsp;&nbsp("
                "<a href='https://github.com/' target='_blank' rel='noreferrer'>" INTL_REPORT_ISSUE "</a>"
